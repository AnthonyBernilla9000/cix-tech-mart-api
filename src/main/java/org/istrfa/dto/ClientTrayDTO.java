...
//    private String idfirebase; // Id del cliente en firebase
    ...
    private String districtProvinceName; //Provincia del cliente
    private String districtProvinceDepartmentName; //Departamento del cliente
